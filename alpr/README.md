# &#128065; `alpr` - You Only Look Once service
...
## Service variables
+ `ALPR_CONFIG` - configuration of ALPR; `tinyv2`, `tinyv3`,`v2`, or `v3`
+ `ALPR_ENTITY` - entity to count; defaults to `all`
+ `ALPR_PERIOD` - seconds between updates; defaults to `0`
+ `ALPR_THRESHOLD` - minimum probability; default `0.25`; range `0.0` to `1.0`
...
![](samples/mock-output.png?raw=true "ALPR")
