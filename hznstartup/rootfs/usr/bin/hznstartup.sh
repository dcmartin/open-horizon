...
## initialize horizon
hzn_init ${HZNSTARTUP_EXCHANGE_URL:-${HZN_EXCHANGE_URL}}
...
## configuration
CONFIG='{"timestamp":"'$(date -u +%FT%TZ)'","exchange":"'${HZNSTARTUP_EXCHANGE_URL}'","org":"'${HZNSTARTUP_EXCHANGE_ORG}'","apache":{"conf":"'${APACHE_CONF}'","htdocs": "'${APACHE_HTDOCS}'","cgibin": "'${APACHE_CGIBIN}'","host": "'${APACHE_HOST}'","port": "'${APACHE_PORT}'","admin": "'${APACHE_ADMIN}'","pidfile":"'${APACHE_PID_FILE:-none}'","rundir":"'${APACHE_RUN_DIR:-none}'"}}'
